...
export function RagPreview() {
  ...
  if (!currentHtml) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-zinc-950 text-zinc-600 gap-3">
  ...
  return (
    <div className="flex-1 flex flex-col bg-zinc-950 overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-4 py-2 bg-zinc-900 border-b border-zinc-800 shrink-0">
        ...
        <button onClick={handlePrint} className="flex items-center gap-1 px-3 py-1 border border-zinc-700 rounded text-xs text-zinc-400 hover:bg-zinc-800">
          <Printer size={12} /> 인쇄
        </button>
